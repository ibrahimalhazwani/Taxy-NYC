...
color <- c("#ff9c12","#b0deff","#acecd5","#f7b685", "#bbded6","#4285f4","#ed8e89","#f3eba5","#94c691", "#f5b7b7","#b4a8e0", "#8ac6d1","#b5ead7","#e0bbe4", "#deff8b", "#779ecc", "#fecbd9","#ffb347", "#4baea0", "#e0fefe", "#ff9aa2", "#b4a24c", "#08bf7c", "#4d8ab5", "#db2e2a","#ffd300", "#a8a9ad", "#c36a2d", "#cc45f2","#9bd6d9", "#ff756d", "#77df79")
