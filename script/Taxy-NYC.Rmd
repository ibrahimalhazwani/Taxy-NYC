...
color <- c("#ed8e89", "#f7b685", "#f3eba5","#94c691","#9bd6d9","#b4a8e0","#9fc0de","#ffb6b9", "#8ac6d1", "#fae3d9","#bbded6", "#a7e9af","#e0bbe4", "#deff8b","#ffb447", "#b5ead7", "#77df79", "#ffb347", "#779ecc", "#ff756d", "acecd5","#ffb447", "#e0bbe4")

colors <- paste(color, collapse = '", "')
