...
In New York City the transportation is divided between public transportation such as metropolitan or buses and private transportation where we can find taxis and ride-hailing companies like Uber or Lyft.
...
The scope of this project is to analyse the most frequent route made just by the yellow taxy and which were the most common zone where taxi picks-up or drops-off the people during the month of January 2019.  
...
DOL_map 
```
What we can see from the map above, is that as before inside the Manhanttan zone the yellow taxis drop-off is intense. But what we can see is that also outside, excluding the JFK airport, yellow taxis are dropping-off people. An assumption of this could be that people that work inside the Manhattan zone may lived outside this could also explain why we can find a high number of picks-up in the central zone of Manhattan.  
...
color <- c("#ed8e89", "#acecd5","#f7b685","#bbded6","#f3eba5","#94c691", "#f5b7b7","#b4a8e0", "#8ac6d1","#e0bbe4", "#deff8b","#b0deff", "#b5ead7", "#77df79", "#ffb347", "#779ecc", "#ff756d", "#fecbd9", "#4baea0", "#e0fefe", "#ff9aa2", "#b4a24c", "#08bf7c", "#4d8ab5", "#db2e2a","#ffd300", "#67c7eb", "#a8a9ad", "#c36a2d", "#ff9c12", "#cc45f2","#9bd6d9")
...
p <- sankeyNetwork(Links = links, Nodes = nodes,
              ...
              Value = "value", NodeID = "name", iterations = 20,
...
This was just a starting point of data exploration and visualization about the private transportation in New York City.  
This analysis could go further for example by analizing the trafic generated by the green taxi and then by ride-hailing companies.  
If instead we want to investigate more the yellow taxi we could analize how the citizen pay for the ride and if the zone where they are picking-up or dropping-off the taxi ha some relationship with the tips or the number of passenger.